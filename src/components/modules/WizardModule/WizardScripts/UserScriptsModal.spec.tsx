...
describe("UserScriptsModal", () => {
  ...
  it("renders a file picker per phase with the three phase labels", () => {
    ...
    expect(getByText("OS morphing: before OS mount")).toBeTruthy();
    expect(getByText("OS morphing: after OS mount")).toBeTruthy();
    expect(getByText("Replica first boot")).toBeTruthy();
