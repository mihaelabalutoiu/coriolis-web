...
export const USER_SCRIPT_PHASE_OPTIONS: {
  ...
  { label: "OS morphing: before OS mount", value: "osmorphing_pre_os_mount" },
  { label: "OS morphing: after OS mount", value: "osmorphing_post_os_mount" },
  { label: "Replica first boot", value: "replica_first_boot" },
];
...
export const USER_SCRIPT_PHASE_DESCRIPTIONS: Record<UserScriptPhase, string> = {
  ...
  replica_first_boot:
    "Injected during OS morphing and executed when the replica VM boots for the first time.",
};
...
// Identifies where a user script applies: a global OS type or a single instance.
